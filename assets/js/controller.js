...
$.getJSON('activity.json', function(data) {
	...
	function displayFinalSlide(){
			...
			xhttp.open("GET", "http://localhost:3000/ip?q1="+result[0]+'&q2='+result[1]+'&q3='+result[2]+'&q4='+result[3]+'&q5='+result[4]+'&q6='+result[5]+'&q7='+result[6]+'&q8='+result[7]+'&q9='+result[8], true);
			xhttp.send();
